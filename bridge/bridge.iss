...
Source: "{#APPNAME}\problems\*";  DestDir: "{app}\bin\{#APPNAME}\problems"; Flags: onlyifdoesntexist
Source: "{#APPNAME}\problems\bts\*";  DestDir: "{app}\bin\{#APPNAME}\problems\bts"; Flags: onlyifdoesntexist
