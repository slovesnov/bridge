...
enum STRING_ID {
	...
	STRING_REDOUBLED,
	STRING_DEFENDERS,
	STRING_EXPORT_THE_RESULTS_OF_ALL_DEALS_TO_CSV_FILE,
	STRING_SEPARATOR,
	STRING_CSV_FILES,
	STRING_FIX_CARDS_HELP,
	STRING_EXPORT_TO_CSV_FILE,
...
enum PLAYERBOX_NAME_TYPE {
	PLAYERBOX_NAME_TYPE_SIMPLE,
	PLAYERBOX_NAME_TYPE_UNDERLINED,
	PLAYERBOX_NAME_TYPE_WITH_CHECKBOX
};
