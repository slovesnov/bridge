...
enum REWRITE_CSS_OPTION {
	REWRITE_CSS_MAIN_FILE = 1,
	REWRITE_CSS_CUSTOM_FILE_FONT_COLOR = 1 << 1,
	REWRITE_CSS_CUSTOM_FILE_BACKGROUND_COLOR = 1 << 2,
	REWRITE_CSS_CUSTOM_FILE_BACKGROUND_IMAGE = 1 << 3,
};
