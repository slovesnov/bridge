...
const int PREFERANS_ORDER_FIRST_MOVE = 2;
const int PREFERANS_ORDER_OTHER_MOVES = 246;

const int PREFERANS_ORDER_FIRST_MOVE_NT = 2;
const int PREFERANS_ORDER_OTHER_MOVES_NT = 6;

const int PREFERANS_ORDER_FIRST_MOVE_MISERE = 5;
const int PREFERANS_ORDER_OTHER_MOVES_MISERE = 0;
